          ...
          <div className="border rounded p-3">
            ...
            <div>
              ...
              <div className="form-check">
                ...
                <label
                  className="form-check-label"
                  htmlFor="wd-chkbox-media-recordings"
                >
                  Media Recordings
                </label>
              </div>
              <div className="form-check">
                ...
                <label
                  className="form-check-label"
                  htmlFor="wd-chkbox-student-annotations"
                >
                  Student Annotation
                </label>
              </div>
              <div className="form-check">
                ...
                <label
                  className="form-check-label"
                  htmlFor="wd-chkbox-file-uploads"
                >
                  File Uploads
                </label>
              </div>
