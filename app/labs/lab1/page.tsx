    ...
    <div id="wd-lab1">
      ...
      <div id="wd-p-tag">
        ...
        <p id="wd-p-3">
          ...
          them as one contiguous piece of text.
        </p>
      ...
      <div id="wd-lists">
        ...
        My favorite recipe - Box Waffle Mix:
        <ol id="wd-your-favorite-recipe">
          <li>Prepare wet and dry ingredients.</li>
          <li>Add the box mix along with 3/4 cup of water to a bowl.</li>
          <li>Stir to combine.</li>
          <li>Add in chocolate chips and blueberries to the wet mix.</li>
          <li>
            Pour batter onto the skillet and press the waffle press down.
          </li>
          <li>Cook for about 5 minutes.</li>
          <li>
            Open up and serve alongside some whipped cream or syrup.
          </li>
        </ol>
        ...
        <ul id="wd-your-books">
          <li>Ill give you the sun by Jandy Nelson</li>
          <li>Piranesi by Susanna Clarke</li>
          <li>The Starless Sea by Erin Morgenstern</li>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <textarea
            ...
            rows={10}
          >
            Phasellus nec massa ac ipsum condimentum interdum. Maecenas et
            suscipit diam, vitae imperdiet ligula. Proin in ipsum feugiat,
            pharetra erat malesuada, pretium orci. Maecenas nec justo eu quam
            consequat molestie. Nunc nec egestas quam. Maecenas et vehicula dui.
            Fusce lectus velit, accumsan in lacus id, pharetra varius nisi. Cras
            eget ultrices metus, vitae condimentum neque. Integer sem enim,
            commodo id libero efficitur, auctor porttitor erat. Integer lobortis
            eros id accumsan commodo. Nullam convallis, orci nec tempor dignissim,
            est ante scelerisque quam, luctus lobortis neque lectus vel lacus.
          </textarea>
